namespace Ordering.Infrustructure.Data.Extentions
{
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers => 
            new List<Customer>
             {
                Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Ronny", "MahlanguRonny@gmail.com"),
                Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Mpesh", "Mpesh@gmail.com")
             };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("Ronny", "Mahlangu", "MahlanguRonny@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
                var address2 = Address.Of("Mpesh", "Mahlangu", "Mpesh@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");
